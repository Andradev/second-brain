---
source_path: "01-raw/videos/processed/Crie um Agente de IA no WhatsApp com CRM (Guia Completo n8n + Antigravity).md"
...
Source path: `01-raw/videos/processed/Crie um Agente de IA no WhatsApp com CRM (Guia Completo n8n + Antigravity).md`
...
- [[03-wiki/entities/supabase|Supabase]]
...
- The source treats AI automation as a client-service asset, reinforcing the [[03-wiki/concepts/ai-native-business-models|AI-Native Business Models]] idea that better packaging and visibility can justify higher project value.
