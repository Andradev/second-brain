# Pack de revisão semanal

## Objetivo

Fluxo semanal para revisar padrões, fontes pendentes e perguntas abertas.
...
2. Usar `09-reviews/weekly-review.md`.
3. Usar `09-reviews/review-open-questions.md`.
4. Usar `09-reviews/review-pending-sources.md`.
5. Usar `07-system-evolution/analyze-recurring-topics.md`.
...
- 09-reviews/weekly-review.md
- 09-reviews/review-open-questions.md
- 09-reviews/review-pending-sources.md
...
Use ao fechar uma semana. Não executar automaticamente; apenas documentar o fluxo até que o usuário autorize a execução.
