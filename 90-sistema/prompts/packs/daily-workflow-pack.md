# Pack de fluxo diário

## Objetivo

Fluxo diário para capturar, classificar e revisar sem executar automaticamente.
...
Use para rotina diária de organização leve. Não executar automaticamente; apenas documentar o fluxo até que o usuário autorize a execução.
