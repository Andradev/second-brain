# Pack de gestão de projetos

## Objetivo

Fluxo para analisar ideias e manter projetos confirmados.
...
1. Usar `08-projects/analyze-project-idea.md`.
2. Usar `08-projects/promote-idea-to-project.md`.
3. Usar `08-projects/create-project-structure.md`.
4. Usar `08-projects/update-project-context.md`.
5. Usar `08-projects/update-project-tasks.md`.
6. Usar `08-projects/review-project-status.md`.
...
- 08-projects/analyze-project-idea.md
- 08-projects/promote-idea-to-project.md
- 08-projects/create-project-structure.md
- 08-projects/update-project-context.md
- 08-projects/update-project-tasks.md
- 08-projects/review-project-status.md
...
Use para projetos sem pular confirmação humana. Não executar automaticamente; apenas documentar o fluxo até que o usuário autorize a execução.
